...
class GenSourceOracle {
    ...
    public static void main(String[] args) throws IOException {
        ...
        writer.write("package com.ooo.project.gensource.result;\n\n" +
                ...
                "   @Id\n" +
                "   @GeneratedValue(strategy = GenerationType.AUTO, generator = \"G_" + CaseFormat.UPPER_CAMEL.to(CaseFormat.UPPER_UNDERSCORE, entityName) + "\")\n" +
                "   @SequenceGenerator(sequenceName = \"S_" + CaseFormat.UPPER_CAMEL.to(CaseFormat.UPPER_UNDERSCORE, entityName) + "\", name = \"G_" + CaseFormat.UPPER_CAMEL.to(CaseFormat.UPPER_UNDERSCORE, entityName) + "\", allocationSize = 1)\n" +
                "   private Long id;\n\n" +
        ...
        writer.write("package com.ooo.project.gensource.result;\n\n" +
                ...
                "            if (resultOptional.isEmpty()) return ResponseEntity.status(HttpStatus.NOT_FOUND).body(\"Not found \" + id);\n" +
